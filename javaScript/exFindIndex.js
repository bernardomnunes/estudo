...
// 2. Encontre, na lista abaixo, a posição que se encontra o item com o "titulo" igual a "Carro de Fórmula 1",
//  guarde-a em uma variável e logue-a no console.
...
const listaDeDesejos = [
  ...
  {
    titulo: "Carro de Formula 1",
    quantidadeEstoque: 1,
  },
];

const index = listaDeDesejos.findIndex((item) => {
  return item.titulo === "Carro de Formula 1";
});
console.log(index);
